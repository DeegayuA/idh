...
<body>
    ...
    <h1 class="header-text">
        ...
        <h2 class="sub-header-text">Doctor List Login - Patient Queuing System</h2>
...
<script>
    ...
    $('#login-form').submit(function(e) {
        ...
        _this.find('button[type="submit"]').text('Logging in Doctors List...');
        $.ajax({
            url: './../Actions.php?a=d_login',
            method: 'POST',
            data: $(this).serialize(),
            dataType: 'JSON',
